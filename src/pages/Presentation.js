// src/pages/Presentation.js - Part 1
...
const testimonials = [
  {
    ...
    content: 'This AI platform has revolutionized our content creation process. We\'ve seen a 300% increase in productivity.'
  },
  {
    name: 'Michael Chen',
    ...
    company: 'DesignHub',
    image: '/api/placeholder/100/100',
    content: 'The image generation quality is outstanding. It\'s become an essential tool in our design workflow.'
  },
  {
    ...
    company: 'MediaPro',
    image: '/api/placeholder/100/100',
    content: 'The ease of use and quality of output is remarkable. It\'s like having an entire creative team at your fingertips.'
  }
];
// src/pages/Presentation.js - Part 2
...
const Presentation = () => {
    ...
    return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed">
                Harness the power of advanced AI to generate high-quality text and images. 
      ...
      <div className="py-24 relative" data-animate id="testimonials">
        {/* Background Effects */}
            ...
            <div className="relative bg-gradient-to-r from-primary-600 to-blue-600 p-12 md:p-16">
              ...
              <div className="relative max-w-3xl mx-auto text-center">
                ...
                <p className="text-xl text-white/90 mb-12">
                  Join thousands of creators and professionals already using our AI platform.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Help Center', 'API Status', 'Contact', 'Privacy'].map(item => (
                  <li key={item}>
                    <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                      {item}
                    </a>
